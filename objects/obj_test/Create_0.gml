...
var _panel = gui_panel_create_ext(800, 400, -500, 0, 0.1, 500, 400, 0x6b6965, 0xfcba05, 0xb3860c, true);
...
gui_panel_addComponent(_panel, 250, 0, _label);
gui_panel_addComponent(_panel, 100, 100, _button);
gui_panel_addComponent(_panel, 400, 100, _image);
gui_panel_addComponent(_panel, 100, 200, _slider);
gui_panel_addComponent(_panel, 100, 300, _checkBox);
gui_panel_addComponent(_panel, 400, 300, _textbox);
