...
gui_panel_addComponent(_panel, 30, 100, gui_image_create(0, 0, spr_ats_stone32, true));
gui_panel_addComponent(_panel, 30, 200, _button);
gui_panel_addComponent(_panel, 30, 300, gui_label_create(0, 0, "Label!", font_32, true));
gui_panel_addComponent(_panel, 30, 400, _slider);
gui_panel_addComponent(_panel, 30, 500, _checkBox);

gui_textField_create(250, 150, "Hallo", "InputField", font_32, c_white, true);
